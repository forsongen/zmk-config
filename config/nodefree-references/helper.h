...
#define ZMK_COMBO(...)                                                         \
  MACRO_CHOOSER5(__VA_ARGS__, ZMK_COMBO_5_ARGS, ZMK_COMBO_4_ARGS)(__VA_ARGS__)
...
#define ZMK_COMBO_5_ARGS(name, combo_bindings, keypos, combo_layers,           \
                         combo_timeout)                                        \
  / {                                                                          \
    combos {                                                                   \
...
#else
#define OS_UNICODE_LEAD                                                        \
  &macro_tap &kp RALT &kp U // Windows + WinCompose (default)
#endif
#endif
  ...
  / {                                                                          \
    ...
    name:                                                                      \
      name {                                                                   \
        ...
        tap - ms = <0>;                                                        \
        #binding - cells = <0>;                                                \
        bindings = <OS_UNICODE_LEAD>, <&macro_tap unicode_bindings>,           \
        <OS_UNICODE_TRAIL>;                                                    \
      };                                                                       \
    };                                                                         \
  };
